...
2. Inside the people page, you can also click on Films buttons, where it will have the list of films that person was in. It will have the title of the movie, episodes, and all other detailed information about the film.
3. Inside the film page, you can see a list of characters. Each character can be clicked, and once you click on it, it will redirect you to the characters page that was in that movie. 
